...
import unittest
from controller.controller_maas import Token, get_supported_series, create_cloud_file, create_credentials_file, create_controller
import api.w_juju as juju
...
class TestMaas(unittest.TestCase):
    def setUp(self):
        self.token = Token('http://193.190.127.161/MAAS', Auth(juju.get_user(), juju.get_password()))
